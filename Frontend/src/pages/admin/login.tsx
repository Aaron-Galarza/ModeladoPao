...
const AdminLogin = () => {
  ...
  return (
    <div className="login-page flex flex-col items-center min-h-screen pt-8 md:justify-center md:pt-0">
      <div className="login-content w-full max-w-md px-4 md:flex md:items-center md:justify-center">
